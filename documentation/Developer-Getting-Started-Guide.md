...
* Run `build.sh`. This will run front end, api, and database containers. Once all containers are running, you can put localhost:3000 in the browser to see the website. 
...
* Run `cleanup.sh`. This will stop and remove the containers. 
